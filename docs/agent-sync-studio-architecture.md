...
- Key lifecycle policy UI beyond local generate/rotate/export/forget/trusted recipient profiles: encrypted backup/restore for lost-device recovery, remote recipient rotation playbooks, and stronger stale-recipient warnings.
