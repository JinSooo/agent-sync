...
- Scanner and compatibility-report pruning for generated cache/dependency trees, with Rust and legacy JS regression coverage to prevent plugin dependency LevelDB files from polluting native DB/index evidence.
